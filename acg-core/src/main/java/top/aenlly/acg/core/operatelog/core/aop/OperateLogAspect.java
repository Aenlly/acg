package top.aenlly.acg.core.operatelog.core.aop;
...
import top.aenlly.acg.common.optlog.annotations.OperateLog;
import top.aenlly.acg.common.optlog.enums.OperateTypeEnum;
...
import static top.aenlly.acg.common.enums.GlobalErrorCode.INTERNAL_SERVER_ERROR;
import static top.aenlly.acg.common.enums.GlobalErrorCode.OK;
...
public class OperateLogAspect {
     ...
     * 用于记录操作内容的上下文
     *
     * @see top.aenlly.acg.core.operatelog.core.service.OperateLog#getContent()
     */
    private static final ThreadLocal<String> CONTENT = new ThreadLocal<>();
    /**
     * 用于记录拓展字段的上下文
     *
     * @see top.aenlly.acg.core.operatelog.core.service.OperateLog#getExts()
     */
    ...
    private void log0(ProceedingJoinPoint joinPoint,
            ...
            ApiOperation apiOperation,
            Date startTime, Object result, Throwable exception) {
        top.aenlly.acg.core.operatelog.core.service.OperateLog operateLogObj = new top.aenlly.acg.core.operatelog.core.service.OperateLog();
        // 补全通用字段
    ...
    private static void fillUserFields(top.aenlly.acg.core.operatelog.core.service.OperateLog operateLogObj) {
        operateLogObj.setUserId(WebFrameworkUtils.getLoginUserId());
        operateLogObj.setUserType(WebFrameworkUtils.getLoginUserType());
    }

    private static void fillModuleFields(top.aenlly.acg.core.operatelog.core.service.OperateLog operateLogObj,
    ...
    private static void fillRequestFields(top.aenlly.acg.core.operatelog.core.service.OperateLog operateLogObj) {
        // 获得 Request 对象
    ...
    private static void fillMethodFields(top.aenlly.acg.core.operatelog.core.service.OperateLog operateLogObj,
            ProceedingJoinPoint joinPoint,
            OperateLog operateLog,
            Date startTime, Object result, Throwable exception) {
        ...
        if (result instanceof CommonResult) {
            ...
            operateLogObj.setResultCode(OK.getCode());
        }
