package top.aenlly.acg.common.utils.date;
...
public class DateUtils {
    ...
    public static final String FORMAT_YEAR_MONTH_DAY_CHINESE = "yyyy年MM月";
    ...
    public static String localDateToString(LocalDate localDate, String format) {
        return Opt
                ...
                .map(m -> m.format(DateTimeFormatter.ofPattern(format)))
                .orElse(null);
    }
    ...
    public static String format(LocalDate date, String dateFormat, Locale local) {
        ...
        if (StringUtils.hasText(dateFormat)) {
            dateFormat = FORMAT_YEAR_MONTH_DAY;
        }
        if (local == null) {
