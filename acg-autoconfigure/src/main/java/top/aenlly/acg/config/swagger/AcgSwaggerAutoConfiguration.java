package top.aenlly.acg.config.swagger;
...
@ConditionalOnProperty(prefix = "acg.swagger", value = "enable", havingValue = "true", matchIfMissing = true)
@EnableConfigurationProperties(SwaggerProperties.class)
public class AcgSwaggerAutoConfiguration {
...
//                .apis(basePackage("com.hisun.rencai.module.system")) // 可用于 swagger 无法展示时使用
